            ...
            <div class="nk-sidebar-menu" data-simplebar>
                <ul class="nk-menu">
                    <li class="nk-menu-item">
                        <a href="resident/send_request.php" class="nk-menu-link">
                            <span class="nk-menu-icon"><em class="icon ni ni-pen2"></em></span>
                            <span class="nk-menu-text">Send Request</span>
                        </a>
                    </li><!-- .nk-menu-item -->
                    <li class="nk-menu-item">
                        <a href="resident/give_comment.php" class="nk-menu-link">
                            <span class="nk-menu-icon"><em class="icon ni ni-notice"></em></span>
                            <span class="nk-menu-text">Give Comment</span>
                        </a>
                    </li><!-- .nk-menu-item -->
                    <li class="nk-menu-item">
                        <a href="resident/view_profile.php" class="nk-menu-link">
