...
if (isset($_GET['status'])) {
    ...
    if ($_GET['status'] == 'active') {
        ...
        header("location:manage_employer.php");
                                        ...
                                        <div class="datatable-wrap my-3">
                                            <table
                                                ...
                                                <tbody>
                                                    ...
                                                    <?php
                                                    $sql = mysqli_query($conn, "SELECT users.id as user_id, `fName`, `lName`, `username`, `email`,role.roleType as role, `password`, `userPhoto`, `role_id`, `code`, `status`, `account_status`, `date` FROM `users` INNER JOIN role on role_id = role.id WHERE role.roleType ='employer' AND status ='verified'");
                                                        ...
                                                        <td class="nk-tb-col nk-tb-col-tools">
                                                            <ul class="nk-tb-actions gx-1">
                                                                ...
                                                                <li class="nk-tb-action-hidden">
                                                                    <a href="systemadministrator/manage_employer.php?id=<?php echo $row['user_id'] ?>&status=disable"
                                                                ...
                                                                <?php
                                                                    ...
                                                                    ?>
                                                                <li class="nk-tb-action-hidden">
                                                                    <a href="systemadministrator/manage_employer.php?id=<?php echo $row['user_id'] ?>&status=active"
                                                                        class="btn btn-trigger btn-icon"
                                                                        data-toggle="tooltip" data-placement="top"
