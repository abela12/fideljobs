                                ...
                                <div class="nk-block nk-block-lg">
                                    <div class="nk-block-head">
                                        <div class="nk-block-head-content">
                                            <h4 class="nk-block-title">Data List For Employer</h4>
                                                                ...
                                                                <td class="nk-tb-col nk-tb-col-tools">
                                                                    <ul class="nk-tb-actions gx-1">
                                                                        ...
                                                                        <li class="nk-tb-action-hidden">
                                                                            <a href="systemadministrator/manage_account.php?id=<?php echo $row['id'] ?>&status=disable"
                                                                        ...
                                                                        <?php
																			...
																			?>
                                                                        <li class="nk-tb-action-hidden">
                                                                            <a href="systemadministrator/manage_account.php?id=<?php echo $row['id'] ?>&status=active"
                                                                                class="btn btn-trigger btn-icon"
                                                                                data-toggle="tooltip"
                                                                                data-placement="top" title=""
