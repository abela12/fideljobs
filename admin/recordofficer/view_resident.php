...
if (isset($_GET['status'])) {
    ...
    if ($_GET['status'] == 'active') {
        mysqli_query($conn, "UPDATE `resident` SET `status`= 'active' WHERE `id`= '$id'");
        // $alert = true;
        // $alertMsg1 = "resident Active !!";
        // $alertStatus = "alert-success";
        // $alertMsg2 = " account status has been updated accordingly. ";
        header("location:view_resident.php");
    } else if ($_GET['status'] == 'disable') {
        mysqli_query($conn, "UPDATE `resident` SET `status`= 'disable' WHERE `id`= '$id'");
        $_SESSION['delmsg'] = "resident Suspend !!";
        header("location:view_resident.php");
    }
}
                                                ...
                                                <div class="datatable-wrap my-3">
                                                    <table
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <?php
                                                            $sql = mysqli_query($conn, "SELECT * FROM `resident` WHERE `recordOfficerId` = '$recordOfficerId'");
                                                            ...
                                                            <tr class="nk-tb-item even">
                                                                ...
                                                                <td class="nk-tb-col">
                                                                    <div class="user-card">
                                                                        ...
                                                                        <div class="user-info">
                                                                            <span class="tb-lead">
                                                                                <?php echo htmlspecialchars($firstName . ' ' . $middleName . ' ' . $lastName) ?><span
                                                                ...
                                                                <td class="nk-tb-col nk-tb-col-tools">
                                                                    <ul class="nk-tb-actions gx-1">
                                                                        ...
                                                                        <li class="nk-tb-action-hidden">
                                                                            <a href="recordOfficer/view_resident.php?id=<?php echo $row['id'] ?>&status=disable"
                                                                        ...
                                                                        <?php
                                                                            ...
                                                                            ?>
                                                                        <li class="nk-tb-action-hidden">
                                                                            <a href="recordOfficer/view_resident.php?id=<?php echo $row['id'] ?>&status=active"
                                                                                class="btn btn-trigger btn-icon"
                                                                                data-toggle="tooltip"
                                                                                data-placement="top" title=""
                                                                            ...
                                                                            <div class="drodown">
                                                                                ...
                                                                                <div
                                                                                    ...
                                                                                    <ul class="link-list-opt no-bdr">
                                                                                        ...
                                                                                        <li><a
                                                                                                href="recordOfficer/view_resident_details.php?id=<?php echo $row['id'] ?>"><em
