<li class="nav-item dropdown notification_dropdown">
    <a class="nav-link  ai-icon" href="javascript:;" role="button" data-toggle="dropdown">
        ...
        $select_notification = mysqli_query($conn, "SELECT * FROM `notification` WHERE `receiver` = 'employer' ORDER BY `notification`.`id` ASC LIMIT 3");
        ...
        ?>
        <span class="badge light text-white bg-primary"><?php echo $count ?></span>
    </a>
            ...
            <ul class="timeline">
                ...
                <li>
                    <div class="timeline-panel">
                        ...
                        <a href="notification-detail.php?notificationId=<?php echo $id ?>">
                            <div class="media-body">
                                <h6 class="mb-1"><?php echo $data['title'] ?></h6>
                                <small class="d-block"><?php echo timePosted($post_time) ?></small>
