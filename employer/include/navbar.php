        ...
        <nav class="navbar navbar-expand">
            <div class="collapse navbar-collapse justify-content-between">
                ...
                <ul class="navbar-nav header-right">
                    <li class="nav-item dropdown header-profile nav-item dropdown d-none d-xl-flex">
                        <a class="btn btn-primary" href="post-job.php">+ Add Post</a>
                    </li>
                                ...
                                <ul class="timeline">
                                    <li>
                                        <div class="timeline-panel">
                                            ...
                                            <div class="media-body">
                                                <h6 class="mb-1">Alpha Apply Your jobs</h6>
                                    ...
                                    <li>
                                        <div class="timeline-panel">
                                            ...
                                            <div class="media-body">
                                                <h6 class="mb-1">ploy apply your jobs</h6>
                                                <small class="d-block">29 July 2021 - 02:26 PM</small>
                                            </div>
                                        </div>
                                    </li>
                    ...
                    <li class="nav-item dropdown notification_dropdown">
                        <a class="nav-link bell bell-link" href="javascript:;">
                            ...
                            <span class="badge light text-white bg-primary">4</span>
                        </a>
                    </li>
                    ...
                    <li class="nav-item dropdown header-profile">
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            ...
                            <a href="my-jobs.php" class="dropdown-item ai-icon">
