                ...
                <div class="modal-content">
                    ...
                    <form id="form" action="action.php" method="post" enctype="multipart/form-data">
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                <textarea maxlength="900" name="aboutYourSelf" id="aboutYourSelf" rows="7" class="form-control bg-transparent" placeholder="Use this space to show clients you have the skills and experience they're looking for.Describe your strengths and skills Highlight projects, accomplishments and educationKeep it short and make sure it's error-free" onkeydown="limitText(this.form.aboutYourSelf,this.form.countdown,500);" onkeyup='limitText(this.form.message,this.form.countdown,500);'></textarea>
                                You have
                            ...
                            <div class="form-group users-list">
                                ...
                                <input type="file" name="coverImage" id="coverImage" class="form-control-file" id="userPhoto" accept="image/*" onchange="preview_image(event)">
                            ...
                            <div id='loader' style='display:none;'>
                                <img src='assets/images/loader/load.gif' width='32px' height='32px'>
                        ...
                        <div class="modal-content">
                            ...
                            <form id="updateForm" action="updateBio.php" method="post" enctype="multipart/form-data">
                                <div class="modal-body">
                                    <!-- Enter a single sentence description of your professional skills/experience (e.g. Expert Web Designer with Ajax experience) -->
                                    <div class="form-group">
                                        <input type="text" name="title" value="<?php echo htmlspecialchars($Title); ?>" id="title" class="form-control input-default" placeholder="Title">
                                    </div>
                                    <div class="form-group">
                                        <textarea maxlength="900" name="aboutYourSelf" id="aboutYourSelf" rows="7" class="form-control bg-transparent" placeholder=""><?php echo htmlspecialchars($aboutYourSelf) ?></textarea>

                                    </div>

                                    <div class="form-group users-list">
                                        <img src="./<?php echo htmlspecialchars($coverImage) ?>" class="img-fluid rounded-circle" alt="" style="height: auto; max-width: 300px;
                                        ">
                                    ...
                                    <div class="form-group users-list">
                                        <img src="./<?php echo htmlspecialchars($profileImage) ?>" class="img-fluid rounded-circle" alt="" style="height: auto; max-width: 300px;
                                        ">
                                        <label for="userPhoto">Profile Photo(Recommend 196 X 196)</label>
                                        <input type="file" name="profileImage" class="form-control-file" id="profile_pic" accept="image/*" onchange="cover_image(event)">
                                        <img class="rounded-circle" id="img" width="150px" />
                                    ...
                                    <div class="form-group col-6">
                                        <label for="Date">Date Of Birth</label>
                                        <input type="date" name="date" value="<?php echo $dateOfBirth ?>" id="Date" class="form-control">
                                    </div>
