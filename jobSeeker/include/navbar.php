                ...
                <div class="header-left">
                    <div class="search_bar dropdown show">
                        <div class="dropdown-menu p-0 m-0 show">
                            <form action="search-results-jobs.php" method="get">
                                <input class="form-control" type="search" name="search_name"
                                    placeholder="Search Jobs Here" aria-label="Search">
                                <button type="submit" name="search" class="badge mt-2 pull-right">Search</button>
                            </form>
                        </div>
                ...
                <ul class="navbar-nav header-right">
                    <li class="nav-item dropdown notification_dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            ...
                            <a class="all-notifications" href="javascript:;">See all notification <i
                    ...
                    <li class="nav-item dropdown header-profile side">
                        ...
                        <a class="nav-link" href="#">
                            ...
                            <img src="<?php echo $profileImage ?>" class="image-fluid rounded-circle bg-dark" width="20"
                                alt="" />
                        </a>
                        <?php
                            }
